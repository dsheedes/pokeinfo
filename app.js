...
function updateBase(gid){
  connection.query("UPDATE general SET prefix = ?, boss = ?, last = ?, boss_last = ?, event_last = ?, last_updated = default WHERE gid = ?", [base.prefix, base.boss, base.last, base.boss_last, base.event_last, base.last_updated, gid], (err, res, fields) => {
    if(err){
